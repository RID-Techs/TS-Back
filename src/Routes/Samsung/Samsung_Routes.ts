...
router.post("/add/buds", upload, async(req: Request, res: Response) => {
...
router.get("/buds", async (req: Request, res: Response) => {
  await GetAllBuds(req, res);
});
router.get("/buds/:id", async (req: Request, res: Response) => {
