...
export const AddGalaxyPhone = async (req, res) => {
    try {
      ...
      values (${phone_name}, ${pictureUrl}, ${phone_ram}, ${phone_rom}, ${phone_screen_type}, ${phone_curved_screen}, ${Number(phone_screen_size)}, ${phone_screen_resolution}, ${phone_chip}, ${Number(phone_main_camera)}, ${Number(phone_selfie)}, ${phone_dual_sim}, ${phone_esim}, ${phone_card_slot}, ${phone_dex}, ${phone_fingerprint}, ${phone_stylus}, ${Number(phone_battery)}, ${phone_galaxy_ai}, ${phone_wired_charging}, ${phone_wireless_charging}, ${phone_mark}, ${phone_type}, ${phone_model}, ${Number(phone_price)}, ${phone_available_colors})
      returning *
    `;
